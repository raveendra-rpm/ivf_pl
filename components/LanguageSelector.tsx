  ...
  return (
    <div className="relative" ref={dropdownRef}>
              ...
              <button
                ...
                className={`w-full flex items-center justify-between px-3 py-2 rounded-xl text-[13px] font-semibold transition-all duration-200 ${
                  currentLang === lang.code
                    ...
                    : "text-gray-600 hover:bg-pink-50 hover:text-primary-pink"
                }`}
              >
      ...
      <style jsx global>{`
        ...
        .goog-te-banner-frame, .goog-te-banner-frame.skiptranslate, .VIpgJd-ZVi9od-ORHb-OEVmcd, iframe.skiptranslate { display: none !important; }
        .goog-te-gadget {
