          ...
          <div className="lg:col-span-4 space-y-8 pr-0 lg:pr-8 pt-8">
            <Link href="/" className="inline-block">
              <img
                ...
                className="h-12 w-auto max-w-[190px] rounded-xl object-contain md:h-14 md:max-w-[230px] xl:h-16 xl:max-w-[270px]"
              />
            </Link>
        ...
        <div className="border-t border-gray-100 dark:border-gray-800 pt-8 mt-4 flex flex-col md:flex-row items-center justify-between gap-6 text-sm text-gray-500 dark:text-gray-400 font-medium relative z-10">
          <p className="text-center md:text-left">
            ...
            <a
              ...
              className="hover:text-[#ED2793] text-[#145390] transition-colors font-extrabold"
            >
              Sarthak Tech
            </a>
          </p>
