...
export default function DoctorsSection() {
  ...
  return (
    <section id="doctors" className="py-20 md:py-28 bg-[#f8fbff] relative overflow-hidden">
      {/* Background blobs */}
            ...
            <div key={index} className="group relative bg-white rounded-[2.5rem] p-3 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgb(20,83,144,0.08)] border border-transparent hover:border-[#145390]/10 transition-all duration-500 overflow-hidden flex flex-col">
              ...
              <div className="pt-5 px-3 pb-3 text-left flex-1 flex flex-col">
                ...
                <p className="text-[#64748b] text-[15px] leading-relaxed mb-4">
                  <span className="font-semibold text-[#145390]">{doctor.designation}</span>
                </p>
                ...
                <div className="mt-auto">
                  ...
                  <Link href={`/doctors/${doctor.slug}`} className="w-full bg-[#f8fbff] hover:bg-[#145390] text-[#145390] hover:text-white border border-[#e8f1fb] hover:border-[#145390] transition-all duration-300 font-bold text-[15px] py-3 rounded-2xl flex items-center justify-center gap-2 group/btn shadow-sm hover:shadow-md">
                    Consult Now 
