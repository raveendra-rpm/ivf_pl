...
export default function GynaecologicalProceduresPage() {
  return (
        ...
        <div className="relative bg-[#060f24] overflow-hidden min-h-[420px] md:min-h-[500px] flex items-center">
          ...
          <div className="container mx-auto px-4 md:px-8 max-w-6xl relative z-10 py-20">
            <div className="flex items-center gap-2 mb-6 text-sm text-white/50 font-medium">
              ...
              <span>›</span>
              <span className="text-white font-semibold">Gynaecological Procedures</span>
            </div>
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold text-white leading-tight mb-6 max-w-2xl">
              Advanced Surgical <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ED2793] to-[#ff7eb3]">Solutions</span>
            </h1>
            <p className="text-white/70 text-base md:text-lg max-w-xl leading-relaxed mb-10">
              At Popular IVF, we offer advanced, minimally invasive surgical procedures to diagnose and treat underlying gynaecological conditions, improving your chances of conception.
            </p>
          ...
          <div className="container mx-auto px-4 md:px-8 max-w-6xl py-10">
            <div className="flex flex-col md:flex-row gap-6 md:gap-12 items-start md:items-center">
              <div className="flex-1">
                <h2 className="text-xl md:text-2xl font-extrabold text-[#145390] mb-2">Expert Surgical Team</h2>
                <p className="text-gray-500 text-sm md:text-[15px] leading-relaxed">
                  Our expert surgeons utilize state-of-the-art laparoscopic and hysteroscopic techniques to manage conditions like endometriosis, fibroids, uterine polyps, and pelvic adhesions with minimal discomfort and faster recovery times.
                </p>
              </div>
        ...
        <section className="py-20 md:py-28 bg-[#f4f8fd]">
          <div className="container mx-auto px-4 md:px-8 max-w-6xl">
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-[#145390]">Surgical Procedures</h2>
              <p className="text-gray-500 text-sm md:text-base mt-3 max-w-xl mx-auto">Advanced diagnostics and interventions for optimal reproductive health.</p>
            </div>
              ...
              {treatments.map((item) => (
                ...
                >
                  ...
                  <div className="p-8 flex flex-col flex-grow">
                    <h3 className="text-[20px] font-extrabold text-[#145390] mb-2 group-hover:text-[#ED2793] transition-colors leading-snug">{item.title}</h3>
                    <p className="text-gray-500 text-[15px] leading-relaxed flex-grow">{item.desc}</p>
                  </div>
