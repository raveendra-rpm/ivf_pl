...
export default function DonorServicesPage() {
  return (
        ...
        <div className="relative bg-[#060f24] overflow-hidden min-h-[420px] md:min-h-[500px] flex items-center">
          ...
          <div className="container mx-auto px-4 md:px-8 max-w-6xl relative z-10 py-20">
            <div className="flex items-center gap-2 mb-6 text-sm text-white/50 font-medium">
              ...
              <span>›</span>
              <span className="text-white font-semibold">Donor Services</span>
            </div>
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold text-white leading-tight mb-6 max-w-2xl">
              Third-Party <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ED2793] to-[#ff7eb3]">Reproduction</span>
            </h1>
            <p className="text-white/70 text-base md:text-lg max-w-xl leading-relaxed mb-10">
              When standard treatments are not enough, our donor programs provide a pathway to parenthood with strict ethical guidelines, rigorous screening, and absolute confidentiality.
            </p>
          ...
          <div className="container mx-auto px-4 md:px-8 max-w-6xl py-10">
            <div className="flex flex-col md:flex-row gap-6 md:gap-12 items-start md:items-center">
              <div className="flex-1">
                <h2 className="text-xl md:text-2xl font-extrabold text-[#145390] mb-2">Building Families With Confidence</h2>
                <p className="text-gray-500 text-sm md:text-[15px] leading-relaxed">
                  We understand that considering donor services can be emotionally complex. Our dedicated counselors and coordinators will guide you through every step, ensuring you feel supported and informed throughout the process.
                </p>
              </div>
        ...
        <section className="py-20 md:py-28 bg-[#f4f8fd]">
          <div className="container mx-auto px-4 md:px-8 max-w-6xl">
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-[#145390]">Donor Programs</h2>
              <p className="text-gray-500 text-sm md:text-base mt-3 max-w-xl mx-auto">Ethical, confidential, and comprehensive donor solutions.</p>
            </div>
