      ...
      <main className="flex-grow pt-[72px] xl:pt-[84px] bg-white">
        ...
        <div className="relative py-24 md:py-32 overflow-hidden">
          <div className="absolute inset-0">
            <img src="/images/treatments/food_&_nutrition_banner.jpg" alt="Food & Nutrition" className="w-full h-full object-cover" />
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            ...
            <div className="flex items-center justify-center gap-2 mt-4 text-sm text-white/90 font-medium flex-wrap drop-shadow-md">
              ...
              <span>›</span>
              <span className="text-white font-bold">Food & Nutrition</span>
            </div>
          </div>
        </div>
            ...
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
              ...
              <div className="lg:w-1/2">
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold text-primary-blue leading-tight mb-6">
                  Understanding <span className="text-primary-pink">Food & Nutrition</span>
                </h2>
                ...
                <div className="bg-white border border-gray-100 shadow-none rounded-2xl p-6 md:p-8 relative overflow-hidden group hover:border-primary-pink/30 transition-colors">
                  ...
                  <div className="space-y-4 text-gray-700 text-[15px] md:text-[17px] leading-relaxed relative z-10">
                    <p>
                      Healthy nutrition supports reproductive health, treatment readiness, and overall wellbeing during the fertility journey.
                    </p>
                    <p>
                      A balanced diet, hydration, healthy weight, sleep, and lifestyle correction can improve the body's response to fertility treatment.
                    </p>
                  </div>
                ...
                <div className="mt-8 flex items-center gap-4 bg-blue-50 px-5 py-4 rounded-xl border border-blue-100">
                  ...
                  <p className="text-sm font-semibold text-gray-700">
                    A balanced diet improves your body's response to treatment.
                  </p>
                </div>
              </div>
              ...
              <div className="lg:w-1/2 w-full">
                <div className="relative rounded-3xl overflow-hidden aspect-[4/3] shadow-sm group">
                  <img
                    src="/images/treatments/understanding_food_&_nutrition_img.jpg"
                  ...
                  <div className="absolute top-6 right-6 bg-white/95 backdrop-blur-sm rounded-2xl px-5 py-3 shadow-lg border border-white/20">
                    <p className="text-xs text-gray-500 font-semibold uppercase tracking-wide">Nutrition</p>
                    <p className="text-primary-blue font-extrabold text-[15px]">Healthy Diet</p>
                  </div>
                  ...
                  <div className="absolute bottom-6 left-6 bg-gradient-to-r from-[#ED2793] to-[#d61b7f] text-white rounded-2xl px-6 py-4 shadow-xl border border-white/20">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-xs font-medium opacity-90 uppercase tracking-widest">Wellness</p>
                        <p className="font-extrabold text-lg">Overall Wellbeing</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="container mx-auto px-4 md:px-8 max-w-6xl relative z-10">
            <div className="text-center mb-12 md:mb-16">
              ...
              <p className="text-gray-500 mt-4 max-w-2xl mx-auto">
                Discover how lifestyle and diet choices impact your fertility journey.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Include protein, whole grains, fruits, vegetables, nuts, seeds, and healthy fats.",
                  img: "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&w=600&q=80"
                },
                {
                  num: "02",
                  title: "Lifestyle Support",
                  desc: "Nutrition works best with regular sleep, stress control, and doctor-guided activity.",
                  img: "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?auto=format&fit=crop&w=600&q=80"
                },
                {
                  num: "03",
                  title: "Treatment Readiness",
                  desc: "Good nutrition can support hormonal balance and general health during treatment.",
        ...
        {/* ── HELPFUL NUTRITION HABITS (ICON CARDS) ── */}
        <section className="py-20 md:py-28 bg-[#f8fbff] relative">
          <div className="container mx-auto px-4 md:px-8 max-w-6xl relative z-10">
            ...
            <div className="flex flex-wrap justify-center gap-6 max-w-5xl mx-auto">
              {[
                { text: "Eat fresh home-cooked meals", icon: "🍳" },
                { text: "Include iron, folate, and protein-rich foods", icon: "🥦" },
                { text: "Limit junk food and sugary drinks", icon: "🚫" },
                { text: "Stay hydrated", icon: "💧" },
                { text: "Follow doctor advice for supplements", icon: "💊" }
              ].map((item, idx) => (
                <div 
                  key={idx} 
        ...
        <section className="py-16 md:py-20 bg-gradient-to-r from-primary-blue via-[#1a6abf] to-[#0e3d6e] relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-8 max-w-4xl text-center relative z-10">
            ...
            <p className="text-blue-100 text-[15px] md:text-base mb-8 max-w-xl mx-auto">
              Our experts can guide you towards the right dietary and lifestyle choices to support your fertility goals. Let us help you plan for a healthy pregnancy.
            </p>
