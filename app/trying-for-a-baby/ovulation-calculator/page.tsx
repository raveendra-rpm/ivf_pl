            ...
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
              ...
              <div className="lg:w-1/2">
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold text-primary-blue leading-tight mb-6">
                  Understanding <span className="text-primary-pink">Ovulation Calculator</span>
                </h2>
                ...
                <div className="bg-white border border-gray-100 shadow-none rounded-2xl p-6 md:p-8 relative overflow-hidden group hover:border-primary-pink/30 transition-colors">
                  ...
                  <div className="space-y-4 text-gray-700 text-[15px] md:text-[17px] leading-relaxed relative z-10">
                    <p>
                      An ovulation calculator helps estimate the fertile window in a menstrual cycle for couples trying to conceive.
                    </p>
                    <p>
                      It gives a useful estimate, but irregular cycles, PCOS, hormonal issues, or age-related factors may need medical guidance.
                    </p>
                  </div>
                ...
                <div className="mt-8 flex items-center gap-4 bg-blue-50 px-5 py-4 rounded-xl border border-blue-100">
                  ...
                  <p className="text-sm font-semibold text-gray-700">
                    Track your fertile days to maximize your chances of natural conception.
                  </p>
                </div>
              </div>
              ...
              <div className="lg:w-1/2 w-full">
                <div className="relative rounded-3xl overflow-hidden aspect-[4/3] shadow-sm group">
                  ...
                  <div className="absolute top-6 right-6 bg-white/95 backdrop-blur-sm rounded-2xl px-5 py-3 shadow-lg border border-white/20">
                    <p className="text-xs text-gray-500 font-semibold uppercase tracking-wide">Tracking</p>
                    <p className="text-primary-blue font-extrabold text-[15px]">Fertile Window</p>
                  </div>
                  ...
                  <div className="absolute bottom-6 left-6 bg-gradient-to-r from-[#ED2793] to-[#d61b7f] text-white rounded-2xl px-6 py-4 shadow-xl border border-white/20">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-extrabold text-lg">Medical Guidance</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="container mx-auto px-4 md:px-8 max-w-6xl relative z-10">
            <div className="text-center mb-12 md:mb-16">
              ...
              <p className="text-gray-500 mt-4 max-w-2xl mx-auto">
                Essential facts about using an ovulation calculator effectively.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Helps identify days when chances of conception may be higher.",
                  img: "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?auto=format&fit=crop&w=600&q=80"
                },
                {
                  num: "02",
                  title: "Cycle Awareness",
                  desc: "Supports tracking of menstrual cycle patterns and ovulation timing.",
                  img: "https://images.unsplash.com/photo-1505576399279-565b52d4ac71?auto=format&fit=crop&w=600&q=80"
                },
                {
                  num: "03",
                  title: "Medical Guidance",
                  desc: "If cycles are irregular or pregnancy is delayed, evaluation is recommended.",
        ...
        <section className="py-20 md:py-28 bg-[#f8fbff] relative">
          <div className="container mx-auto px-4 md:px-8 max-w-6xl relative z-10">
            ...
            <div className="flex flex-wrap justify-center gap-6 max-w-5xl mx-auto">
              {[
                { text: "Cycles are irregular", icon: "📅" },
                { text: "Trying for pregnancy for 12 months", icon: "🗓️" },
                { text: "Trying for 6 months above age 35", icon: "⏳" },
                { text: "Known PCOS or endometriosis", icon: "🧬" },
                { text: "History of miscarriage or IVF failure", icon: "⚠️" }
              ].map((item, idx) => (
                <div 
                  key={idx} 
        ...
        <section className="py-16 md:py-20 bg-gradient-to-r from-primary-blue via-[#1a6abf] to-[#0e3d6e] relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-8 max-w-4xl text-center relative z-10">
            ...
            <p className="text-blue-100 text-[15px] md:text-base mb-8 max-w-xl mx-auto">
              Calculators provide a good estimate, but every body is different. If you have concerns about your cycle, speak to our experts.
            </p>
