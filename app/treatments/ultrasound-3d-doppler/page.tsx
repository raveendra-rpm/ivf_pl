...
export default function UltrasoundDopplerPage() {
  return (
        ...
        <div className="bg-gradient-to-r from-primary-blue via-[#ED2793] to-[#ff7eb3] py-16 md:py-24 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            ...
            <div className="flex items-center justify-center gap-2 mt-4 text-sm text-white/80 font-medium flex-wrap">
              ...
              <span>›</span>
              <span className="text-white font-semibold">Ultrasound / Doppler</span>
            </div>
          </div>
        </div>
            ...
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
              ...
              <div className="lg:w-1/2">
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold text-primary-blue leading-tight mb-6">
                  Ultrasound – <span className="text-primary-pink">3D Ultrasound / Colour Doppler</span>
                </h2>
                ...
                <div className="bg-white border border-gray-100 shadow-sm rounded-2xl p-6 md:p-8 relative overflow-hidden group hover:border-primary-pink/30 transition-colors">
                  ...
                  <p className="text-gray-700 text-[15px] md:text-[17px] leading-relaxed relative z-10">
                    Diagnosing the probable cause of infertility is complex and can involve several fertility investigations. Ultrasound scans are crucial to identify and treat a wide range of fertility problems. The test is capable of identifying and gathering information women’s fertility potential and gives a clear view of structural problems that could be a deterrent in becoming pregnant. Popular IVF facility offers a gamut of fertility investigations including access to high quality ultrasound equipment with Doppler and 3D facilities. Our team of experienced clinicians trained in reproductive medicine specialize in evidence-based treatment protocols built upon detailed 2D, 3D, CD (Colour Doppler) and Power Doppler investigations.
                  </p>
                ...
                <div className="mt-8 flex items-center gap-4 bg-blue-50 px-5 py-4 rounded-xl border border-blue-100">
                  ...
                  <p className="text-sm font-semibold text-gray-700">
                    High quality ultrasound equipment providing detailed 2D, 3D, and Doppler imaging.
                  </p>
                </div>
              </div>
              ...
              <div className="lg:w-1/2 w-full">
                <div className="relative rounded-3xl overflow-hidden aspect-[4/3] shadow-2xl group">
                  <img
                    ...
                    alt="Advanced 3D Ultrasound and Colour Doppler"
                  ...
                  <div className="absolute top-6 right-6 bg-white/95 backdrop-blur-sm rounded-2xl px-5 py-3 shadow-lg border border-white/20">
                    <p className="text-xs text-gray-500 font-semibold uppercase tracking-wide">Technology</p>
                    <p className="text-primary-blue font-extrabold text-[15px]">3D & Doppler</p>
                  </div>
                  ...
                  <div className="absolute bottom-6 left-6 bg-gradient-to-r from-[#ED2793] to-[#d61b7f] text-white rounded-2xl px-6 py-4 shadow-xl border border-white/20">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-xs font-medium opacity-90 uppercase tracking-widest">Expertise</p>
                        <p className="font-extrabold text-lg">Experienced Clinicians</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <section className="py-16 md:py-20 bg-gradient-to-r from-primary-blue via-[#1a6abf] to-[#0e3d6e] relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-8 max-w-4xl text-center relative z-10">
            <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-4">
              Get a Clear View of Your Fertility Potential
            </h2>
            <p className="text-blue-100 text-[15px] md:text-base mb-8 max-w-xl mx-auto">
              Schedule an advanced 3D ultrasound or Colour Doppler scan with our specialized clinicians for a comprehensive fertility assessment.
            </p>
