...
export default function TubalPatencyTestsPage() {
  return (
        ...
        <div className="bg-gradient-to-r from-primary-blue via-[#ED2793] to-[#ff7eb3] py-16 md:py-24 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            ...
            <div className="flex items-center justify-center gap-2 mt-4 text-sm text-white/80 font-medium flex-wrap">
              ...
              <span>›</span>
              <span className="text-white font-semibold">Tubal Patency Tests</span>
            </div>
          </div>
        </div>
            ...
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
              ...
              <div className="lg:w-1/2">
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold text-primary-blue leading-tight mb-6">
                  Tubal Patency Tests <span className="text-primary-pink">(HSG, SSG)</span>
                </h2>
                ...
                <div className="bg-white border border-gray-100 shadow-sm rounded-2xl p-6 md:p-8 relative overflow-hidden group hover:border-primary-pink/30 transition-colors">
                  ...
                  <p className="text-gray-700 text-[15px] md:text-[17px] leading-relaxed relative z-10">
                    Fallopian tubes need to be open and healthy so as to achieve pregnancy. To ensure healthy fallopian tubes, tubal patency tests are done. These are basically fertility investigations to detect blockages and adhesions in the fallopian tubes. Almost 15-20% of infertility cases account for tubal defects. As recommendation, Popular IVF advises tubal assessment to be done as a first major pointer of fertility investigations.
                  </p>
                ...
                <div className="mt-8 flex items-center gap-4 bg-blue-50 px-5 py-4 rounded-xl border border-blue-100">
                  ...
                  <p className="text-sm font-semibold text-gray-700">
                    A crucial first step in fertility investigations to detect any blockages or adhesions.
                  </p>
                </div>
              </div>
              ...
              <div className="lg:w-1/2 w-full">
                <div className="relative rounded-3xl overflow-hidden aspect-[4/3] shadow-2xl group">
                  <img
                    ...
                    alt="Tubal Patency Testing and Diagnostics"
                  ...
                  <div className="absolute top-6 right-6 bg-white/95 backdrop-blur-sm rounded-2xl px-5 py-3 shadow-lg border border-white/20">
                    <p className="text-xs text-gray-500 font-semibold uppercase tracking-wide">Investigation</p>
                    <p className="text-primary-blue font-extrabold text-[15px]">Tubal Assessment</p>
                  </div>
                  ...
                  <div className="absolute bottom-6 left-6 bg-gradient-to-r from-[#ED2793] to-[#d61b7f] text-white rounded-2xl px-6 py-4 shadow-xl border border-white/20">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-xs font-medium opacity-90 uppercase tracking-widest">Diagnostics</p>
                        <p className="font-extrabold text-lg">HSG & SSG</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <section className="py-16 md:py-20 bg-gradient-to-r from-primary-blue via-[#1a6abf] to-[#0e3d6e] relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-8 max-w-4xl text-center relative z-10">
            ...
            <p className="text-blue-100 text-[15px] md:text-base mb-8 max-w-xl mx-auto">
              Schedule your tubal assessment today. Identifying blockages or adhesions early is a major pointer toward a successful pregnancy.
            </p>
