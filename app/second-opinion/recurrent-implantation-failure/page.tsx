...
export default function RecurrentImplantationFailurePage() {
  return (
      ...
      <main className="flex-grow pt-[72px] xl:pt-[84px] bg-white">
        ...
        <div className="relative py-24 md:py-32 overflow-hidden">
          <div className="absolute inset-0">
            <img src="/images/treatments/recurrent_implantation_failure_banner.jpg" alt="Recurrent Implantation Failure" className="w-full h-full object-cover" />
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            ...
            <div className="flex items-center justify-center gap-2 mt-4 text-sm text-white/90 font-medium flex-wrap drop-shadow-md">
              ...
              <span>›</span>
              <span className="text-white font-bold">Recurrent Implantation Failure</span>
            </div>
          </div>
        </div>
            ...
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
              ...
              <div className="lg:w-1/2">
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold text-primary-blue leading-tight mb-6">
                  Understanding <span className="text-primary-pink">Recurrent Implantation Failure</span>
                </h2>
                ...
                <div className="bg-white border border-gray-100 shadow-none rounded-2xl p-6 md:p-8 relative overflow-hidden group hover:border-primary-pink/30 transition-colors">
                  ...
                  <div className="space-y-4 text-gray-700 text-[15px] md:text-[17px] leading-relaxed relative z-10">
                    <p>
                      Recurrent implantation failure is when good-quality embryos do not implant after repeated IVF attempts.
                    </p>
                    <p>
                      A detailed evaluation of embryo, uterus, hormones, immunity, and lifestyle factors can help guide the next treatment plan.
                    </p>
                  </div>
                ...
                <div className="mt-8 flex items-center gap-4 bg-blue-50 px-5 py-4 rounded-xl border border-blue-100">
                  ...
                  <p className="text-sm font-semibold text-gray-700">
                    A detailed evaluation to discover root causes and guide your next treatment plan.
                  </p>
                </div>
              </div>
              ...
              <div className="lg:w-1/2 w-full">
                <div className="relative rounded-3xl overflow-hidden aspect-[4/3] shadow-sm group">
                  <img
                    src="/images/treatments/recurrent_implantation_failure_img.jpg"
                    alt="Recurrent Implantation Failure Evaluation"
                  ...
                  <div className="absolute top-6 right-6 bg-white/95 backdrop-blur-sm rounded-2xl px-5 py-3 shadow-lg border border-white/20">
                    ...
                    <p className="text-primary-blue font-extrabold text-[15px]">Detailed Review</p>
                  </div>
                  ...
                  <div className="absolute bottom-6 left-6 bg-gradient-to-r from-[#ED2793] to-[#d61b7f] text-white rounded-2xl px-6 py-4 shadow-xl border border-white/20">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-extrabold text-lg">Personalised Plan</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="container mx-auto px-4 md:px-8 max-w-6xl relative z-10">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-500 mt-4 max-w-2xl mx-auto">
                A methodical approach to uncover hidden factors affecting implantation and to personalize your care.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="group bg-white rounded-3xl p-8 shadow-md border border-gray-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-primary-blue mb-4">Detailed Review</h3>
                <p className="text-gray-600 leading-relaxed font-medium">
                  Previous IVF cycles, embryo quality, transfer details, and reports are carefully reviewed.
                </p>
              </div>
              ...
              <div className="group bg-white rounded-3xl p-8 shadow-md border border-gray-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-primary-blue mb-4">Uterine Assessment</h3>
                <p className="text-gray-600 leading-relaxed font-medium">
                  Hysteroscopy, scans, and endometrial evaluation may be advised.
                </p>
              </div>
              ...
              <div className="group bg-white rounded-3xl p-8 shadow-md border border-gray-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-primary-blue mb-4">Personalised Plan</h3>
                <p className="text-gray-600 leading-relaxed font-medium">
                  Treatment is adjusted based on findings, age, ovarian reserve, and embryo factors.
                </p>
              </div>
        ...
        <section className="py-20 md:py-28 bg-[#f8fbff] relative">
          <div className="container mx-auto px-4 md:px-8 max-w-6xl relative z-10">
            ...
            <div className="flex flex-wrap justify-center gap-6 max-w-5xl mx-auto">
              {[
                { text: "Embryo quality review", icon: "🔬" },
                { text: "Uterine cavity check", icon: "🩺" },
                { text: "Hormonal assessment", icon: "🧬" },
                { text: "Genetic counselling", icon: "💬" },
                { text: "Lifestyle & medical review", icon: "📋" }
              ].map((item, idx) => (
                <div 
                  key={idx} 
        ...
        <section className="py-16 md:py-20 bg-gradient-to-r from-primary-blue via-[#1a6abf] to-[#0e3d6e] relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-8 max-w-4xl text-center relative z-10">
            ...
            <p className="text-blue-100 text-[15px] md:text-base mb-8 max-w-xl mx-auto">
              Our specialists provide a comprehensive evaluation to uncover the root causes of recurrent implantation failure and craft a personalised plan for success.
            </p>
