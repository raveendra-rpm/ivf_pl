...
export default function FertilityAndCancerPage() {
  return (
        ...
        <div className="bg-gradient-to-r from-primary-blue via-[#ED2793] to-[#ff7eb3] py-16 md:py-24 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            ...
            <div className="flex items-center justify-center gap-2 mt-4 text-sm text-white/80 font-medium flex-wrap">
              ...
              <span>›</span>
              <span className="text-white font-semibold">Fertility & Cancer</span>
            </div>
          </div>
        </div>
            ...
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
              ...
              <div className="lg:w-1/2">
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold text-primary-blue leading-tight mb-6">
                  Understanding <span className="text-primary-pink">Fertility & Cancer</span>
                </h2>
                ...
                <div className="bg-white border border-gray-100 shadow-none rounded-2xl p-6 md:p-8 relative overflow-hidden group hover:border-primary-pink/30 transition-colors">
                  ...
                  <div className="space-y-4 text-gray-700 text-[15px] md:text-[17px] leading-relaxed relative z-10">
                    <p>
                      Cancer treatment can sometimes affect future fertility, so timely counselling is important before chemotherapy, radiation, or surgery begins.
                    </p>
                    <p>
                      Popular IVF Centre provides guidance on fertility preservation options so patients can make informed decisions before starting cancer care.
                    </p>
                  </div>
                ...
                <div className="mt-8 flex items-center gap-4 bg-blue-50 px-5 py-4 rounded-xl border border-blue-100">
                  ...
                  <p className="text-sm font-semibold text-gray-700">
                    Timely counselling and preservation options for informed decision making.
                  </p>
                </div>
              </div>
              ...
              <div className="lg:w-1/2 w-full">
                <div className="relative rounded-3xl overflow-hidden aspect-[4/3] shadow-sm group">
                  <img
                    src="/images/treatments/fertility_&_cancer_img.jpg"
                    alt="Fertility and Cancer Counselling"
                  ...
                  <div className="absolute top-6 right-6 bg-white/95 backdrop-blur-sm rounded-2xl px-5 py-3 shadow-lg border border-white/20">
                    <p className="text-xs text-gray-500 font-semibold uppercase tracking-wide">Options</p>
                    <p className="text-primary-blue font-extrabold text-[15px]">Fertility Preservation</p>
                  </div>
                  ...
                  <div className="absolute bottom-6 left-6 bg-gradient-to-r from-[#ED2793] to-[#d61b7f] text-white rounded-2xl px-6 py-4 shadow-xl border border-white/20">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-extrabold text-lg">Early Counselling</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="container mx-auto px-4 md:px-8 max-w-6xl relative z-10">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-500 mt-4 max-w-2xl mx-auto">
                A collaborative approach to safeguard your future family goals before cancer treatment.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="group bg-white rounded-3xl p-8 shadow-md border border-gray-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-primary-blue mb-4">Early Counselling</h3>
                <p className="text-gray-600 leading-relaxed font-medium">
                  Patients are guided about fertility risks and available preservation choices before treatment.
                </p>
              </div>
              ...
              <div className="group bg-white rounded-3xl p-8 shadow-md border border-gray-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-primary-blue mb-4">Preservation Options</h3>
                <p className="text-gray-600 leading-relaxed font-medium">
                  Egg, sperm, embryo, or ovarian tissue freezing may be considered depending on medical condition.
                </p>
              </div>
              ...
              <div className="group bg-white rounded-3xl p-8 shadow-md border border-gray-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-primary-blue mb-4">Coordinated Care</h3>
                <p className="text-gray-600 leading-relaxed font-medium">
                  The fertility team works with the patient and treating doctor to plan safely and quickly.
                </p>
              </div>
          ...
          <div className="container mx-auto px-4 md:px-8 max-w-5xl relative z-10">
            <div className="bg-white rounded-3xl p-8 md:p-12 shadow-xl ring-1 ring-gray-900/5 max-w-4xl mx-auto">
              <div className="text-center mb-10">
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold text-[#145390]">
                  Fertility Preservation May Help With
                </h2>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 max-w-3xl mx-auto">
                {[
                  ...
                  "Young patients with future family goals",
                  "Urgent fertility counselling"
                ].map((item, idx) => (
                  <div 
                    key={idx} 
        ...
        <section className="py-16 md:py-20 bg-gradient-to-r from-primary-blue via-[#1a6abf] to-[#0e3d6e] relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-8 max-w-4xl text-center relative z-10">
            ...
            <p className="text-blue-100 text-[15px] md:text-base mb-8 max-w-xl mx-auto">
              Early counselling and preservation options are crucial before cancer treatments. Let our expert team guide you safely and quickly.
            </p>
