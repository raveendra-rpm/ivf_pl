...
const doctors = [
  ...
  },
  {
    ...
    education: ["MBBS", "MS - Obstetrics & Gynaecology", "DNB - Obstetrics & Gynecology"],
  ...
  },
  {
    ...
    education: ["MBBS", "MD (OBS & GYNAE)", "MS-BHU"],
  ...
  },
  {
    ...
    about: "Dr Madhavi Paramar is a highly skilled Consultant Gynaecologist at Popular Hospital with extensive expertise in Gynecologist / OBGY. Dedicated to providing compassionate patient care and staying at the forefront of medical advancements.",
    education: ["MBBS", "MS"],
          ...
          <div className="container mx-auto max-w-5xl relative z-10">
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
              ...
              <div className="text-center md:text-left flex-1 mt-4 md:mt-6">
                ...
                <h1 className="text-4xl md:text-5xl font-extrabold mb-2">{doctor.name}</h1>
                <p className="text-blue-100 text-lg md:text-xl font-medium mb-4 max-w-xl">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-3xl p-6 shadow-xl shadow-blue-900/5 border border-gray-100 sticky top-24">
                ...
                <div className="border-t border-gray-100 pt-6">
                  <Link href="/book-appointment" className="w-full bg-[#145390] hover:bg-[#0f4070] text-white font-bold py-4 rounded-2xl transition-all duration-300 shadow-lg shadow-blue-900/20 hover:shadow-xl hover:shadow-blue-900/30 flex items-center justify-center gap-2 mb-3">
                    <Calendar className="w-5 h-5" />
                    Book Appointment
                  </Link>
                  <a href="tel:+919151000135" className="w-full bg-white hover:bg-gray-50 text-[#145390] border-2 border-[#145390] font-bold py-4 rounded-2xl transition-all duration-300 flex items-center justify-center gap-2">
